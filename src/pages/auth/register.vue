<script setup lang="ts">
  import Logo from '@/components/layouts/dashboard/logo.vue'
  import AuthFooter from './_components/AuthFooter.vue'
  import FormRegister from './_components/form/FormRegister.vue'
</script>
