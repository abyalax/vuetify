...
const users: User[] = [
  {
    ...
    // Keep permissions for backward compatibility (flattened from roles)
    permissions: [
      { id: 1, key: 'admin.user.read', name: 'Read User' },
      { id: 2, key: 'admin.user.write', name: 'Write User' },
      { id: 3, key: 'admin.user.update', name: 'Update User' },
    ...
    roles: [
      {
        ...
        key: 'candidate',
        permissions: [
          { id: 1, key: 'candidate.playgorund', name: 'Candidate Page' },
        ],
      },
    ],
    // Keep permissions for backward compatibility
    permissions: [
      { id: 1, key: 'candidate.playgorund', name: 'Candidate Page' },
    ],
  },
